...
with open('./data/1st_sys_prompt.json', 'r', encoding='utf-8') as file:
    first_sys_prompt = json.load(file)
...
completion = client.chat.completions.create(
    ...
    messages=[
        {
            "role": "system",
            "content": first_sys_prompt["content"]  # 첫 번째 시스템 프롬프트
        },
        {
            "role": "user",
...
with open('./data/2nd_sys_prompt.json', 'r', encoding='utf-8') as file:
    second_sys_prompt = json.load(file)
...
final_completion = client.chat.completions.create(
    ...
    messages=[
        {
            "role": "system",
            "content": second_sys_prompt["content"]  # 두 번째 시스템 프롬프트 사용
        },
        {
            "role": "user",
